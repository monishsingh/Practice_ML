# -*- coding: utf-8 -*-
"""
Created on Thu Apr 12 19:21:19 2018
...
if __name__ == "__main__":
    ...
    # delta4 = act_layer3 - Y 
     ...
     file = open("insample_error.txt",'w')
   ...
   ###################################################  
     ...
     for i in range(0,len(test_lines)):
         for j in range(0,100):
             act_layer1_test[i][j] = sigmoid(Z_test[i][j])
     ...
     for i in range(0,len(test_lines)):
         for j in range(0,50):
             act_layer2_test[i][j] = sigmoid(Z1_test[i][j])
    ...
    # W3 = np.random.randn(50,1) * np.sqrt(2/100)  
     ...
     for i in range(0,len(test_lines)):
         for j in range(0,1):
             act_layer3_test[i][j] = sigmoid(Z3_test[i][j])
    ...
    ########################## accuracy####################
     ...
     for i in range(0,len(test_lines)):
         for j in range(0,1):
             ...
             if float(act_layer3_test[i]) < 0.5:
                 output_test[i][j] = 1
             else:
                 output_test[i][j] = 0
    ...
    ###################### test accurcy############
     ...
     file = open("outsample_error.txt",'w')
